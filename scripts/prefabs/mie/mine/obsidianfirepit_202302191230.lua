...
local function fn()
    ...
    inst.components.burnable:AddBurnFX("mie_obsidianfirepit", Vector3(0, 0.4, 0), "firefx", true)
    ...
    inst.components.fueled:InitializeFuelLevel(TUNING.FIREPIT_FUEL_START * 2)
