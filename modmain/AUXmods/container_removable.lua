...
local LoadDragPos = function()
    TheSim:GetPersistentString("mone_container_removable", function(load_success, data)
...
AddClassPostConstruct("widgets/containerwidget", function(self)
    if TUNING.FUNCTIONAL_MEDAL_IS_OPEN --[[and config_data.container_removable ~= 1]] then
        -- print("能力勋章(1909182187)已开启，取消该功能。")
        return ;
    end

    if TUNING.DRAGZOOMUIMOD_IS_OPEN and config_data.container_removable ~= 1 then
        -- print("UI拖拽缩放镜像(2885137047)已开启，取消该功能。")
        return ;
    end
