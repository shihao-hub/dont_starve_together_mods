...
return
--Prefab("explode_small", MakeExplosion(), assets),
--Prefab("explode_reskin", MakeExplosion(extras.reskin), assets),
Prefab("mone_reskin_tool_brush_explode_fx", MakeExplosion(extras.reskin_brush), assets),
Prefab("mone_reskin_tool_bouquet_explode_fx", MakeExplosion(extras.reskin_bouquet), assets)
