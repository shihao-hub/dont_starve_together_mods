...
local function fn()
    ...
    inst:SetStateGraph("mone_SGmoondial")

    inst:AddComponent("heater")
    inst.components.heater.heat = -115 -- -115
...
return Prefab("mone_moondial", fn, assets, prefabs),
MakePlacer("mone_moondial_placer", "moondial", "moondial_build", "idle_new")
