...
STRINGS[upper("mone_single_dog")] = L
        and [[
        - 我只允许有我一条狗！
        - 周期探测一定半径内的狗子，每个周期扣除其最大生命值 20% 的血量
        ]]
        or [[]];
-----------------------------------------------------------------------------------------------------------
--[[ 更多物品·一 ]]
...
STRINGS[upper("mie_bundle_state1")] = L
        and [[
        - 主要可以打包有建筑标签的物体、一些指定物体
        - 不能打包的那就是不能打包，如有必要可以让作者补充。
        ]]
        or [[]];
...
STRINGS[upper("mone_honey_ham_stick")] = L
        and [[
        - 一天内效率提高两倍，时间可累加(一次制作三个)
        - 击杀Boss的时候有一定概率触发双倍掉落效果
        ]]
        or [[]];
STRINGS[upper("mone_guacamole")] = L
        and [[
        - 夜视半天，无视沙尘暴，时间不可叠加(一次制作三个)
        ]]
        or [[]];
