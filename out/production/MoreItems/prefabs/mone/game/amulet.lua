...
--table.insert(prefabs, Prefab("mone_amulet", red, assets));

--table.insert(prefabs, Prefab("mone_blueamulet", blue, assets));

--table.insert(prefabs, Prefab("mone_purpleamulet", purple, assets));

-- 设定：整组拾取物品 + 快速采集物品
--table.insert(prefabs, Prefab("mone_orangeamulet", orange, assets, { "sand_puff" }));

--table.insert(prefabs, Prefab("mone_greenamulet", green, assets));

--table.insert(prefabs, Prefab("mone_yellowamulet", yellow, assets, { "yellowamuletlight" }));
--table.insert(prefabs, Prefab("mone_yellowamuletlight", yellowlightfn));
