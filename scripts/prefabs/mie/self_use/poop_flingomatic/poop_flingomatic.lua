...
local assets = {
    ...
    -- 2023-08-01：此处 IMAGE 之前写错成 ATLAS，好像会导致资源导入的时候底层崩溃
    Asset("IMAGE", "images/modules/poop_flingomatic/inventoryimages/poop_flingomatic.tex"),
    Asset("ATLAS", "images/modules/poop_flingomatic/inventoryimages/poop_flingomatic.xml"),
    Asset("IMAGE", "images/modules/poop_flingomatic/minimap/poop_flingomatic.tex"),
    Asset("ATLAS", "images/modules/poop_flingomatic/minimap/poop_flingomatic.xml"),
}
...
local function LaunchProjectile(inst, target, item)
    ...
    inst:DoTaskInTime(waittime, function()
        ...
        local projectile = SpawnPrefab("mie_fertilizer_projectile")
...
local function fn()
    ...
    inst.components.container:WidgetSetup("mie_poop_flingomatic")
...
return Prefab("mie_poop_flingomatic", fn, assets, prefabs),
MakePlacer("mie_poop_flingomatic_placer", "poop_flingomatic", "poop_flingomatic", "placer", true, nil, nil, PLACER_SCALE, nil, nil, placer_postinit_fn)
