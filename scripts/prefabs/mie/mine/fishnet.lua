...
local assets =
{
    ...
    Asset("IMAGE", "images/inventoryimages/mie_fishnet.tex"),
    Asset("ATLAS", "images/inventoryimages/mie_fishnet.xml")
}
...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "mie_fishnet"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/mie_fishnet.xml"
...
return Prefab("mie_fishnet", fn, assets, prefabs)
