...
-- chang
local name = "mie_obsidianfirepit";
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()] = {};
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()].OUT = "火焰渐熄";
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()].EMBERS = "那火快要熄灭了";
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()].LOW = "火在慢慢熄灭";
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()].NORMAL = "温暖的火焰，温暖的我";
STRINGS.CHARACTERS.GENERIC.DESCRIBE[name:upper()].HIGH = "火焰在咆哮！";
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("obsidianfirepit.tex")
    ...
    inst.components.burnable:AddBurnFX("mie_obsidianfirefire", Vector3(0, 0.4, 0))
    ...
    inst.components.fueled:InitializeFuelLevel(TUNING.FIREPIT_FUEL_START * 3)
...
return Prefab("mie_obsidianfirepit", fn, assets, prefabs),
MakePlacer("mie_obsidianfirepit_placer", "firepit", "firepit", "preview")
